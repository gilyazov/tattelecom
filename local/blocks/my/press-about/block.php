...
if($_GET['year'] == "" && $_GET["month"] == "") {
    $technicalWorksFilter = array("PROPERTY_TYPE_VALUE" => "Публикации");
} else {
    // 1. Месяц
    ...
    $technicalWorksFilter = array(
        ...
        "PROPERTY_TYPE_VALUE" => "Публикации"
    );
}
?>

    <h2 class="gl__title">Пресса о компании</h2>
    <?php $APPLICATION->IncludeComponent("bitrix:news.list","tatt-news-press",Array(
            "IBLOCK_TYPE" => "mobile",
            "IBLOCK_ID" => "29",
            "NEWS_COUNT" => "9",
            ...
            "PROPERTY_CODE" => [],
            "CHECK_DATES" => "Y",
            "DETAIL_URL" => "/press-center/press/#ELEMENT_CODE#/",
