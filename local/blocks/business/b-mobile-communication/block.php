<section class="b-mobile-communication gl__section">
                ...
                <li class="intro-cards-container__item service-card-with-photo" data-card-preset="gradient-2">
                    ...
                    <div class="service-card-with-photo__content">
                        ...
                        <div class="service-card-with-photo__footer">
                            ...
                            <div class="service-card-with-photo__btns">
                                <a href="#" class="service-card-with-photo__btn mod-simple service-card-with-photo__details gl__no-default-hover">Подробнее</a>
                                <a href="" class="service-card-with-photo__btn gl__main-btn mod-transparent-2 service-card-with-photo__connect-btn gl__no-default-hover">Выбрать номер</a>
                            </div>
                        </div>
                    </div>
                </li>
