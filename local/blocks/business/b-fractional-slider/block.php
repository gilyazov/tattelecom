<section class="b-fractional-slider gl__section" id="b-fractional-slider-main-host">
    <div class="gl__page-content">
        <h2 class="gl__title">Связь</h2>
        <div class="gl-slider js-swiper" data-swiper-slides-preview="auto" data-swiper-gap="20">
            ...
            <?$APPLICATION->IncludeComponent("bitrix:news.list", "fractional-slider", Array(
                "COMPONENT_TEMPLATE" => "fractional-slider",
