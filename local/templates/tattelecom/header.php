...
<!--        <link rel="apple-touch-icon" href="/local/templates/buisness/Vector.png">-->
    ...
    <script type="text/javascript">
        ...
        _tmr.push({id: "3310517", type: "pageView", start: (new Date()).getTime(), pid: "USER_ID"});
        (function (d, w, id) {
    ...
    <noscript><div><img src="https://top-fwz1.mail.ru/counter?id=3310517;js=na" style="position:absolute;left:-9999px;" alt="Top.Mail.Ru" /></div></noscript>
    <!-- /Top.Mail.Ru counter -->
</head>
<body class="no-touch">
