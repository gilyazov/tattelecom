...
<form action="/search/" method="GET" class="header__input-search-form js-show-when-search">
    <label class="header__input-search-wrapper">
        ...
        <button type="submit" name="s" class="header__search-btn-close js-close-search-btn">
