...
<?endif?>
<?
    $formClass = "application-consultation__form mod-business";
    if ($arParams["FORM_CLASS"]){
        $formClass = $arParams["FORM_CLASS"];
    }
?>
<form name="iblock_add"
      data-need-validation data-parsley-validate data-parsley-focus="none" class="<?=$formClass?> js-business-form"
                            ...
                            case "N":
                                ...
                                <label class="gl-input__wrapper <?=$additionalClass?>">
                                    <input type="<?=$type?>"
                                           ...
                                           name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]; ?>" value="<?=$value?>" />
                                </label>
                                <?
