...
<div class="gl-slider__wrapper swiper-wrapper">
    <?foreach($arResult["ITEMS"] as $arItem):?>
        ...
        <div class="swiper-slide" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            <section class="rates-preview mod-main-page" style="background-image: url('<?=\Tattelecom\Core\Tools::resizeImage($arItem["PREVIEW_PICTURE"]["ID"], 1920, 470)?>')" id="rates-preview-host">
