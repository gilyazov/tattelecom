...
$APPLICATION->SetTitle("Политика конфиденциальности при использовании мобильных приложений и официальных сайтов ПАО «Таттелеком»");
$APPLICATION->SetPageProperty("title", "Политика конфиденциальности при использовании мобильных приложений и официальных сайтов ПАО «Таттелеком»");
